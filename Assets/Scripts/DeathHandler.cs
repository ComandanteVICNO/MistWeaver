...
public class DeathHandler : MonoBehaviour
{
    ...
    public PlayerMovController playerMove;
    ...
    public void StopMovement()
    {
        if (!canMove)
        {
            playerAttack.isAttackAllow=false;
    ...
    IEnumerator RevivePlayer()
    {
        ...
        spriteAnimator.SetBool("isDead", false);
        spriteAnimator.SetBool("isRevived", true);
        ...
        ResetBool();
        canMove = true;
        playerAttack.isAttackAllow = true;
        playerMove.canMove = true;
        playerMove.canJump = true;
        playerMove.canDash = true;
        spriteAnimator.SetBool("isRevived", false);
        canBeAttacked = true;
